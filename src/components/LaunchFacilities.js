...
import LaunchFacilityCard from "./cards/LaunchFacilityCard";
import { pics } from "../const/pics";

function LaunchFacilities({ weather }) {
  ...
  return (
    <article
      width="[object Object]"
      display="flex"
      className="sc-gsTEea sc-kstqJO exkUxL epkVnJ"
    >
      <div width="100%" display="flex" className="sc-gsTEea hjuMS">
        <h3 className="sc-bdfBQB sc-bqyKOL iLfceD">Launch facilities</h3>
        <LaunchFacilityCard
          name="Cape Canaveral"
          label="LC-39A & SLC-40"
        ...
        />
        <div
          className={`launch-facility-container ${
            isClosed ? "launch-facility-closed" : "launch-facility-open"
          }`}
        >
          <LaunchFacilityCard
            name="Vandenerg Base"
        ...
        <div display="flex" className="sc-gsTEea sc-idOiZg kmZhta">
          <button
            display="flex"
            className="sc-gsTEea sc-dmlqKv iyUgRF hBLSDI"
